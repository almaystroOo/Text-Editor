...
//            }
            ...
            if (word.endsWith("e") && !word.endsWith("le") && numSyllables > 1) {
                numSyllables--;
            }
...
//        for (char i : chars) {
//            //  System.out.println("previousIsVowel:"+previousIsVowel);
//            //segue
//            //prev=e current=e
...
//                    //    System.out.println("previousIsVowel updated to:"+previousIsVowel);
//                }
//            } else {
...
//
//        }
//        if (word.endsWith("e") && !word.endsWith("le") && !word.endsWith("ue") && !word.endsWith("ce") && count >= 2) {
//            count--;
//        }        // getNumSyllables method in BasicDocument (module 2) and
//        // EfficientDocument (module 3).
//        System.out.println("word:" + word + " count:" + count);
//        if (word.length() <= 3 && count == 2) {
//            count--;
//        }
//        if (count == 0) {
//            count = 1; // Ensure at least one syllable for non-empty words
//        }
//        return count;
//    }
